...
const NOTAS = [
  {
    versao: '1.16',
    data: '2026-09-24',
    titulo: 'Counter-Strike, desenhos e series',
    itens: [
      'Counter-Strike virou categoria, com 119 perguntas em quatro partes que da para escolher separadas: Lendas, Mapas, Armas e Times.',
      ...
      'Series e TV saiu de dentro de Cinema & TV e virou categoria, com 581 perguntas e uma parte para cada serie: da para jogar so iCarly, so Chaves ou so Friends. Sao 19 partes, de Drake e Josh a Game of Thrones.',
      'As perguntas agora sao sobre os personagens e os detalhes: iCarly, Drake e Josh, The Big Bang Theory, How I Met Your Mother, Breaking Bad, Arrow, The Flash, Dark, Prison Break, Brooklyn Nine-Nine, Todo Mundo Odeia o Chris e Eu, a Patroa e as Criancas.',
      'Bordao de dublagem virou pergunta: "Nao contavam com minha astucia!", "Cale-se, cale-se, voce me deixa louco!", "Meu marido tem dois empregos!", "Legal, legal, legal, sem duvida, sem duvida".',
